...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 157487641, ; hash 0x9631219, from name: aot-Scheduler.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1130823152, ; hash 0x4366fdf0, from name: Scheduler.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 124
	...
	%struct.DSOCacheEntry {
		i64 2468473520, ; hash 0x9321eab0, from name: libaot-Scheduler
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 285
	...
	%struct.DSOCacheEntry {
		i64 3149198564, ; hash 0xbbb4f4e4, from name: Scheduler
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 379
	...
	%struct.DSOCacheEntry {
		i64 3430002035, ; hash 0xcc71ad73, from name: libaot-Scheduler.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 406
	...
	%struct.DSOCacheEntry {
		i64 3865726106, ; hash 0xe66a4c9a, from name: aot-Scheduler
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 447
