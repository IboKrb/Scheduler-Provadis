...
@dso_cache = dso_local local_unnamed_addr global [498 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.78_name, ; name: libaot-System.Web.HttpUtility.dll.so
		ptr null; void* handle (0x0)
	}, ; 12
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6163361047678775326, ; hash 0x5588a837cd5f701e, from name: libaot-Scheduler.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 142
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6352485907685564329, ; hash 0x58289046b045dfa9, from name: libaot-Scheduler
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 148
	...
	%struct.DSOCacheEntry {
		i64 8709620819130758973, ; hash 0x78dec9fd4ca2b73d, from name: Scheduler
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 228
	...
	%struct.DSOCacheEntry {
		i64 11100655817568146590, ; hash 0x9a0d73a6fc05d49e, from name: Scheduler.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 288
	...
	%struct.DSOCacheEntry {
		i64 12269333745592689459, ; hash 0xaa456e0930c3e333, from name: aot-Scheduler.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 327
	...
	%struct.DSOCacheEntry {
		i64 16430477847334423704, ; hash 0xe404c88cbc4b0c98, from name: aot-Scheduler
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Scheduler.dll.so
		ptr null; void* handle (0x0)
	}, ; 446
...
@.env.3 = private unnamed_addr constant [37 x i8] c"3301233a-3265-4d18-a9fe-2db828eca684\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [26 x i8] c"com.companyname.scheduler\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [24 x i8] c"libaot-Scheduler.dll.so\00", align 16
...
@.DSOCacheEntry.78_name = private unnamed_addr constant [37 x i8] c"libaot-System.Web.HttpUtility.dll.so\00", align 16
